...
create index IX_ACT_RU_TASK_OWNER_ on ACT_RU_TASK(OWNER_);
create index IX_ACT_RU_TASK_ASSIGNEE_ on ACT_RU_TASK(ASSIGNEE_);
create index IX_ACT_RU_VARIABLE_TEXT_ on ACT_RU_VARIABLE(TEXT_);
